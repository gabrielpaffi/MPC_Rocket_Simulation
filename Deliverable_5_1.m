...
ph.fig.Name = 'Merged lin. MPC in nonlinear simulation without mass estimation'; % Set a figure title
...
rocket.anim_rate = 5; % Increase this to make the animation faster
ph = rocket.plotvis(T, X, U, Ref);
ph.fig.Name = 'Merged lin. MPC in nonlinear simulation with mass estimation'; % Set a figure title
